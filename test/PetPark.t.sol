...
contract PetParkTest is Test, PetPark {
    ...
    function testCannotAddAnimalWhenNonOwner() public {
        ...
        vm.expectRevert("caller must be owner");
        petPark.add(AnimalType.Fish, 3);
    }
    ...
    function testCannotBorrowWhenAgeZero() public {
        ...
        borrow(0, Gender.Male, AnimalType.Fish);
    }
    ...
    function testBorrowCountDecrement() public {
        petPark.add(AnimalType.Fish, 5);
        uint beforeFishCount = petPark.animalCounts(AnimalType.Fish);
        petPark.borrow(24, Gender.Male, AnimalType.Fish);

        uint afterFishCount = petPark.animalCounts(AnimalType.Fish);
        assertEq(beforeFishCount - 1, afterFishCount);
    }
